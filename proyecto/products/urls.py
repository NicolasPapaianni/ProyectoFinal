...
from products.views import create_product_sin_alcohol, create_product_con_alcohol, formulario, search_products  \
    , bebidas_con_alcohol, bebidas_sin_alcohol, delete_product, update_product
